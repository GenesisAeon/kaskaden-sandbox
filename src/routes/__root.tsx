  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Evidence-Graph der vier Wunderling-Kippelemente: GIS, WAIS, AMOC und Amazonas. Dokumentierte Kopplungen, unklare Vorzeichen markiert, keine Monte-Carlo-Engine.",
      },
